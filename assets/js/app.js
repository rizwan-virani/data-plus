...
(function () {
  ...
  function renderDashboard() {
    ...
    b1.appendChild(el("p.sectsub", { text: "Start here. Understand how the DAO-002 is scored and delivered, and where the credential fits in a data analytics career." }));
    var g1 = el("div.grid");
    g1.appendChild(card({
      icon: "🎓", tag: "OVERVIEW", title: "Exam Mechanics", cls: "",
      desc: "Format, timing, scoring, and question types for the DAO-002 &mdash; the high-stakes details every candidate should internalize before sitting the test.",
    ...
    b5.appendChild(el("p.sectsub", { html: "A realistic, full-length simulation of the DAO-002 &mdash; " + EX.maxQuestions + " questions weighted to the official domain percentages. Sit it under timed conditions to benchmark your readiness." }));
    var g3c = el("div.grid");
    ...
    g5.appendChild(card({
      ...
      desc: "Vetted, free study tools: Professor Messer's full DAO-002 course, the official CompTIA objectives PDF, and trusted community guides.",
  ...
  function openDomain(id) {
    ...
    function render() {
      ...
      Router.open(readerView("Domain " + id, d.title, "DAO-002 Domain " + id + " · " + d.weight + "% of the exam", sections));
    }
  ...
  function openExamMechanics() { Router.open(readerView("Exam mechanics", "Exam Mechanics: DAO-002", "How the exam is built, delivered, and scored", S.examMechanics || [])); }
