...
/* Per-domain metadata. `objectives` mirror the official DA0-002 exam outline. */
DATAPLUS.domainMeta = [
...
DATAPLUS.resources = [
  { icon: "📄", title: "Official CompTIA Data+ DA0-002 Exam Objectives (PDF)", host: "comptia.org",
  ...
  { icon: "🎥", title: "CompTIA Data+ Learning Resources & CertMaster", host: "comptia.org",
    url: "https://www.comptia.org/en-us/certifications/data/",
    desc: "CompTIA's own CertMaster Learn and Practice paths map directly to the DA0-002 objectives, with self-paced lessons, performance-based questions, and readiness checks." },
