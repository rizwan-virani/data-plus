/* ============================================================================
   data+  ::  quizEngine.js  —  ENGINE  (assessment + PBQ runtime)
   The question bank (content/quiz1..5.js) and PBQ database (content/pbqs.js)
   load before this file and populate DATAPLUS.questions / DATAPLUS.pbqs.
   ...
   read from DATAPLUS.exam — the single source of truth — never re-literaled.
   ========================================================================== */
(function () {
  "use strict";
  ...
  /* ===========================================================================
     ...
     Persists two things across every quiz/mock session (localStorage via APP):
       dataplus.objstats.v1 = { "1.2": {c, n}, ... }   per-objective accuracy
       dataplus.missed.v1   = { "D4-071": 1, ... }      questions answered wrong
  ...
  /* ===========================================================================
     ...
     Length and duration come from DATAPLUS.exam (single source of truth).
     =========================================================================== */
